package com.guang.resms.utils.exception;
...
public class ResponseResult<T> {
    ...
    public static <T> ResponseResult<T> success() {
        ...
        return response(HttpEnums.SUCCESS.getCode(), true, HttpEnums.SUCCESS.getMessage(), null);
    }
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> success(HttpEnums httpResponseEnum) {
    ...
    public static <T> ResponseResult<T> success(String message, T data) {
        ...
        return response(HttpEnums.SUCCESS.getCode(), true, message, data);
    }
    ...
    public static <T> ResponseResult<T> success(T data) {
        ...
        return response(HttpEnums.SUCCESS.getCode(), true, HttpEnums.SUCCESS.getMessage(), data);
    }
    ...
    public static <T> ResponseResult<T> success(String message) {
        ...
        return response(HttpEnums.SUCCESS.getCode(), true, message, null);
    }
    ...
    public static <T> ResponseResult<T> fail() {
        ...
        return response(HttpEnums.FAIL.getCode(), false, HttpEnums.FAIL.getMessage(), null);
    }
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> fail(HttpEnums httpResponseEnum) {
    ...
    public static <T> ResponseResult<T> fail(String message, T data) {
        ...
        return response(HttpEnums.FAIL.getCode(), false, message, data);
    }
    ...
    public static <T> ResponseResult<T> fail(T data) {
        ...
        return response(HttpEnums.FAIL.getCode(), false, HttpEnums.FAIL.getMessage(), data);
    }
    ...
    public static <T> ResponseResult<T> fail(String message) {
        ...
        return response(HttpEnums.FAIL.getCode(), false, message, null);
    }
}
