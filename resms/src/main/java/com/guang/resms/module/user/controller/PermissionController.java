...
public class PermissionController {
     ...
     */
    @PostMapping
    @OpLog(module = "权限管理", operationType = "新增权限", level = RiskLevel.MEDIUM, dimensions = { RiskDimension.SYSTEM })
     ...
     */
    @PutMapping
    @OpLog(module = "权限管理", operationType = "更新权限", level = RiskLevel.MEDIUM, dimensions = { RiskDimension.SYSTEM })
     ...
     */
    @DeleteMapping("/{id}")
    @OpLog(module = "权限管理", operationType = "删除权限", level = RiskLevel.HIGH, dimensions = { RiskDimension.SYSTEM }, notifyAdmin = true)
     ...
     */
    @DeleteMapping("/batch")
    @OpLog(module = "权限管理", operationType = "批量删除权限", level = RiskLevel.HIGH, dimensions = { RiskDimension.SYSTEM }, notifyAdmin = true)
