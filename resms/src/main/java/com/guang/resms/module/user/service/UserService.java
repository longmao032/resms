...
public interface UserService {
     ...
     * 根据角色类型获取启用的用户列表
     * 
     * @param roleType 角色类型 (2=销售经理, 3=销售顾问 等)
     * @return 用户选项列表
     */
     ...
     * @param roleId 角色ID
     */
    void createUserRoleAssociation(Integer userId, Integer roleId);
     ...
     * @param roleId 角色ID
     */
    void updateUserRoleAssociation(Integer userId, Integer roleId);
}
