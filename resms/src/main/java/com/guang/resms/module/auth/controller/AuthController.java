package com.guang.resms.module.auth.controller;
...
public class AuthController {
    ...
    public ResponseResult<Map<String, Object>> csrfToken(HttpServletRequest request) {
        String token = UUID.randomUUID().toString().replace("-", "");
        request.getSession(true).setAttribute("csrfToken", token);
        Map<String, Object> data = new HashMap<>();
        data.put("csrfToken", token);
        return ResponseResult.success("获取成功", data);
    }
